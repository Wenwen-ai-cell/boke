...
// that uses this DLL.
//
// Preserve indentation of the block below:
// clang-format off
#if defined(_WIN32)
...
#endif
// This could be defined by a previously included header, e.g. X11/Xlib.h.
#undef Bool
typedef int Bool;
#ifdef __cplusplus
typedef bool okBool;
...
#define OK_PRODUCT_XEM9025          (55)
#define OK_PRODUCT_XEM8320AU25P     (56)
#define OK_PRODUCT_XEM8310AU25P     (57)
#define OK_PRODUCT_FPX9301          (58)
...
enum okEProduct {
	...
	okPRODUCT_XEM9025 = OK_PRODUCT_XEM9025,
	okPRODUCT_XEM8320AU25P = OK_PRODUCT_XEM8320AU25P,
	okPRODUCT_XEM8310AU25P = OK_PRODUCT_XEM8310AU25P,
	okPRODUCT_FPX9301 = OK_PRODUCT_FPX9301,
...
#define OK_API_VERSION_MICRO 11

#define OK_API_VERSION_STRING "5.2.11"
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okDeviceSettings_List(okDeviceSettings_HANDLE hnd, okDeviceSettingNames_HANDLE names);
...
okDLLEXPORT okBool DLL_ENTRY
okScriptValue_GetAsBuffer(okScriptValue_HANDLE h, okBuffer_HANDLE* pbuf);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_AddCustomDevice(const okTDeviceMatchInfo* matchInfo, const okTDeviceInfo* devInfo);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetFPGAResetProfile(
	okFrontPanel_HANDLE hnd, ok_FPGAConfigurationMethod method, okTFPGAResetProfile* profile
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetFPGAResetProfileWithSize(
	okFrontPanel_HANDLE hnd,
	ok_FPGAConfigurationMethod method,
	okTFPGAResetProfile* profile,
	unsigned size
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetFPGAResetProfile(
	okFrontPanel_HANDLE hnd, ok_FPGAConfigurationMethod method, const okTFPGAResetProfile* profile
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetFPGAResetProfileWithSize(
	okFrontPanel_HANDLE hnd,
	ok_FPGAConfigurationMethod method,
...
okFrontPanel_FindUSBDeviceModel(unsigned usbVID, unsigned usbPID);
okDLLEXPORT void DLL_ENTRY
okFrontPanel_GetBoardModelString(okFrontPanel_HANDLE hnd, ok_BoardModel m, char* buf);
...
okDLLEXPORT void DLL_ENTRY
okFrontPanel_GetDeviceListSerial(okFrontPanel_HANDLE hnd, int num, char* buf);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_GetDeviceSensors(okFrontPanel_HANDLE hnd, okDeviceSensors_HANDLE settings);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_GetDeviceSettings(okFrontPanel_HANDLE hnd, okDeviceSettings_HANDLE settings);
#define okFrontPanel_GetDeviceInfo(hnd, info) \
	okFrontPanel_GetDeviceInfoWithSize((hnd), (info), sizeof(okTDeviceInfo))
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_GetDeviceInfoWithSize(okFrontPanel_HANDLE hnd, okTDeviceInfo* info, unsigned size);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAWithReset(
	okFrontPanel_HANDLE hnd, const char* strFilename, const okTFPGAResetProfile* reset
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAFromMemory(
	okFrontPanel_HANDLE hnd, unsigned char* data, unsigned long length
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAFromMemoryWithProgress(
	okFrontPanel_HANDLE hnd,
	unsigned char* data,
	unsigned long length,
	okTProgressCallback callback,
	void* arg
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAFromMemoryWithReset(
	okFrontPanel_HANDLE hnd,
	unsigned char* data,
	unsigned long length,
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_ConfigureFPGAFromFlash(okFrontPanel_HANDLE hnd, unsigned long configIndex);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
...
okDLLEXPORT long DLL_ENTRY okFrontPanel_WriteToBlockPipeIn(
	okFrontPanel_HANDLE hnd, int epAddr, int blockSize, long length, unsigned char* data
);
okDLLEXPORT long DLL_ENTRY okFrontPanel_ReadFromBlockPipeOut(
	okFrontPanel_HANDLE hnd, int epAddr, int blockSize, long length, unsigned char* data
);
...
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_LoadScript(
	okScriptEngine_HANDLE hnd, const char* name, const char* code, okError** err
);
okDLLEXPORT Bool DLL_ENTRY
okScriptEngine_LoadFile(okScriptEngine_HANDLE hnd, const char* path, okError** err);
okDLLEXPORT void DLL_ENTRY
okScriptEngine_PrependToScriptPath(okScriptEngine_HANDLE hnd, const char* dir);
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_RunScriptFunction(
	okScriptEngine_HANDLE hnd,
	const char* name,
	okScriptValues_HANDLE* retval,
	okScriptValues_HANDLE args,
	okError** err
);
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_RunScriptFunctionAsync(
	okScriptEngine_HANDLE hnd,
	okScriptEngineAsyncCallback callback,
	void* data,
	const char* name,
	okScriptValues_HANDLE args,
	okError** err
...
okFrontPanelManager_Construct(okFrontPanelManager_HANDLE self, const char* realm);
okDLLEXPORT okCFrontPanelManager_HANDLE DLL_ENTRY okFrontPanelManager_ConstructWithCallbacks(
	okFrontPanelManager_HANDLE self,
	const char* realm,
	okFrontPanelManager_OnDeviceCallback_t onAdded,
	okFrontPanelManager_OnDeviceCallback_t onRemoved
);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanelManager_StartMonitoringWithCBInfo(
	okCFrontPanelManager_HANDLE hnd, okTCallbackInfo* cbInfo
);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanelManager_StopMonitoring(okCFrontPanelManager_HANDLE hnd);
okDLLEXPORT int DLL_ENTRY okFrontPanelManager_EnterMonitorLoop(
	okCFrontPanelManager_HANDLE hnd, const okTCallbackInfo* cbInfo
);
okDLLEXPORT int DLL_ENTRY okFrontPanelManager_EnterMonitorLoopWithTimeout(
	okCFrontPanelManager_HANDLE hnd, const okTCallbackInfo* cbInfo, int millisecondsTimeout
);
okDLLEXPORT void DLL_ENTRY
okFrontPanelManager_ExitMonitorLoop(okCFrontPanelManager_HANDLE hnd, int exitCode);
okDLLEXPORT okFrontPanel_HANDLE DLL_ENTRY
okFrontPanelManager_Open(okCFrontPanelManager_HANDLE hnd, const char* serial);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanelManager_EmulateTestDeviceConnection(const char* serial, Bool connect);

//
// FrontPanelDevices
//
okDLLEXPORT okCFrontPanelDevices_HANDLE DLL_ENTRY
okFrontPanelDevices_Construct(const char* realm, okError** err);
...
okDLLEXPORT void DLL_ENTRY
okFrontPanelDevices_GetSerial(okCFrontPanelDevices_HANDLE hnd, int num, char* buf);
okDLLEXPORT okFrontPanel_HANDLE DLL_ENTRY
okFrontPanelDevices_Open(okCFrontPanelDevices_HANDLE hnd, const char* serial);
#endif /* okNO_MANAGER */
...
public:
	...
	static ErrorCode
	AddCustomDevice(const okTDeviceMatchInfo& matchInfo, const okTDeviceInfo* devInfo = NULL);
	...
	ErrorCode
	SetFPGAResetProfile(okEFPGAConfigurationMethod method, const okTFPGAResetProfile* profile);
	...
	ErrorCode
	ConfigureFPGAWithReset(const std::string& strFilename, const okTFPGAResetProfile* reset);
	ErrorCode ConfigureFPGAFromMemory(
		unsigned char* data,
		const unsigned long length,
		OpalKelly::ProgressCallback* callback = NULL
	);
	ErrorCode ConfigureFPGAFromMemoryWithReset(
		unsigned char* data, const unsigned long length, const okTFPGAResetProfile* reset
	);
...
{
public:
	okCDeviceSettingNames()
		: h(okDeviceSettingNames_Construct())
	{
	}
...
{
public:
	okCDeviceSettings() { h = okDeviceSettings_Construct(); }

	~okCDeviceSettings() { okDeviceSettings_Destruct(h); }
...
{
public:
	okCDeviceSensors() { h = okDeviceSensors_Construct(); }

	~okCDeviceSensors() { okDeviceSensors_Destruct(h); }

	int GetSensorCount() const { return okDeviceSensors_GetSensorCount(h); }

	okTDeviceSensor GetSensor(int n) const { return okDeviceSensors_GetSensor(h, n); }
...
GetAPIVersionMajor()
{
	return okFrontPanel_GetAPIVersionMajor();
}
inline int
GetAPIVersionMinor()
{
	return okFrontPanel_GetAPIVersionMinor();
}
inline int
GetAPIVersionMicro()
{
	return okFrontPanel_GetAPIVersionMicro();
}

inline const char*
GetAPIVersionString()
{
	return okFrontPanel_GetAPIVersionString();
}

inline bool
CheckAPIVersion(int major, int minor, int micro)
{
...
public:
	...
	ScriptValues
	RunScriptFunction(const std::string& name, const ScriptValues& args = ScriptValues());
...
inline void
okCPLL22150::SetCrystalLoad(double capload)
{
	okPLL22150_SetCrystalLoad(h, capload);
}
inline void
okCPLL22150::SetReference(double freq, bool extosc)
{
	okPLL22150_SetReference(h, freq, extosc);
}
inline double
okCPLL22150::GetReference()
{
	return (okPLL22150_GetReference(h));
}
inline bool
okCPLL22150::SetVCOParameters(int p, int q)
{
...
inline double
okCPLL22150::GetVCOFrequency()
{
	return (okPLL22150_GetVCOFrequency(h));
}
inline void
okCPLL22150::SetDiv1(DividerSource divsrc, int n)
{
	okPLL22150_SetDiv1(h, (ok_DividerSource)divsrc, n);
}
inline void
okCPLL22150::SetDiv2(DividerSource divsrc, int n)
{
	okPLL22150_SetDiv2(h, (ok_DividerSource)divsrc, n);
}
inline okCPLL22150::DividerSource
okCPLL22150::GetDiv1Source()
{
	return ((DividerSource)okPLL22150_GetDiv1Source(h));
}
inline okCPLL22150::DividerSource
okCPLL22150::GetDiv2Source()
{
	return ((DividerSource)okPLL22150_GetDiv2Source(h));
}
inline int
okCPLL22150::GetDiv1Divider()
{
	return (okPLL22150_GetDiv1Divider(h));
}
inline int
okCPLL22150::GetDiv2Divider()
{
	return (okPLL22150_GetDiv2Divider(h));
}
inline void
okCPLL22150::SetOutputSource(int output, okCPLL22150::ClockSource clksrc)
{
	okPLL22150_SetOutputSource(h, output, (ok_ClockSource_22150)clksrc);
}
inline void
okCPLL22150::SetOutputEnable(int output, bool enable)
{
	okPLL22150_SetOutputEnable(h, output, enable);
}
inline okCPLL22150::ClockSource
okCPLL22150::GetOutputSource(int output)
{
	return ((ClockSource)okPLL22150_GetOutputSource(h, output));
}
inline double
okCPLL22150::GetOutputFrequency(int output)
{
	return (okPLL22150_GetOutputFrequency(h, output));
}
inline bool
okCPLL22150::IsOutputEnabled(int output)
{
...
inline bool
okCPLL22393::SetCrystalLoad(double capload)
{
	return okPLL22393_SetCrystalLoad(h, capload);
}
inline void
okCPLL22393::SetReference(double freq)
{
	okPLL22393_SetReference(h, freq);
}
inline double
okCPLL22393::GetReference()
{
	return (okPLL22393_GetReference(h));
}
inline bool
okCPLL22393::SetPLLParameters(int n, int p, int q, bool enable)
{
	return okPLL22393_SetPLLParameters(h, n, p, q, enable) == TRUE;
}
inline bool
okCPLL22393::SetPLLLF(int n, int lf)
{
	return okPLL22393_SetPLLLF(h, n, lf) == TRUE;
}
inline bool
okCPLL22393::SetOutputDivider(int n, int div)
{
	return okPLL22393_SetOutputDivider(h, n, div) == TRUE;
}
inline bool
okCPLL22393::SetOutputSource(int n, okCPLL22393::ClockSource clksrc)
{
	return okPLL22393_SetOutputSource(h, n, (ok_ClockSource_22393)clksrc) == TRUE;
}
inline void
okCPLL22393::SetOutputEnable(int n, bool enable)
{
	okPLL22393_SetOutputEnable(h, n, enable);
}
inline int
okCPLL22393::GetPLLP(int n)
{
	return (okPLL22393_GetPLLP(h, n));
}
inline int
okCPLL22393::GetPLLQ(int n)
{
	return (okPLL22393_GetPLLQ(h, n));
}
inline double
okCPLL22393::GetPLLFrequency(int n)
{
	return (okPLL22393_GetPLLFrequency(h, n));
}
inline int
okCPLL22393::GetOutputDivider(int n)
{
	return (okPLL22393_GetOutputDivider(h, n));
}
inline okCPLL22393::ClockSource
okCPLL22393::GetOutputSource(int n)
{
	return ((ClockSource)okPLL22393_GetOutputSource(h, n));
}
inline double
okCPLL22393::GetOutputFrequency(int n)
{
	return (okPLL22393_GetOutputFrequency(h, n));
}
inline bool
okCPLL22393::IsOutputEnabled(int n)
{
	return okPLL22393_IsOutputEnabled(h, n) == TRUE;
}
inline bool
okCPLL22393::IsPLLEnabled(int n)
{
...
inline void
okCFrontPanel::Swap(okCFrontPanel& fp)
{
	okFrontPanel_HANDLE hOrig = h;
	h = fp.h;
	fp.h = hOrig;
}
inline std::string
okCFrontPanel::GetErrorString(int ec)
{
...
inline const char*
okCFrontPanel::GetLastErrorMessage() const
{
	return okFrontPanel_GetLastErrorMessage(h);
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::AddCustomDevice(const okTDeviceMatchInfo& matchInfo, const okTDeviceInfo* devInfo)
{
	return (okCFrontPanel::ErrorCode)okFrontPanel_AddCustomDevice(&matchInfo, devInfo);
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::RemoveCustomDevice(int productID)
{
...
inline okCFrontPanel::BoardModel
okCFrontPanel::GetDeviceListModel(int num)
{
	return ((okCFrontPanel::BoardModel)okFrontPanel_GetDeviceListModel(h, num));
}
inline std::string
okCFrontPanel::GetDeviceListSerial(int num)
{
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetDeviceSettings(okCDeviceSettings& settings)
{
	return (ErrorCode)okFrontPanel_GetDeviceSettings(h, settings.h);
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetDeviceSensors(okCDeviceSensors& sensors)
{
...
inline void
okCFrontPanel::SetDeviceID(const std::string& str)
{
	okFrontPanel_SetDeviceID(h, str.c_str());
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetBTPipePollingInterval(int interval)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_SetBTPipePollingInterval(h, interval));
}
inline void
okCFrontPanel::SetTimeout(int timeout)
{
	okFrontPanel_SetTimeout(h, timeout);
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ResetFPGA()
{
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGA(const std::string& strFilename)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_ConfigureFPGA(h, strFilename.c_str()));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGAWithReset(
	const std::string& strFilename, const okTFPGAResetProfile* reset
)
{
	return ((okCFrontPanel::ErrorCode
	)okFrontPanel_ConfigureFPGAWithReset(h, strFilename.c_str(), reset));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGAFromMemory(
	unsigned char* data, const unsigned long length, OpalKelly::ProgressCallback* callback
)
{
	ok_ErrorCode ec;
	if (callback) {
		ec = okFrontPanel_ConfigureFPGAFromMemoryWithProgress(
			h, data, length, &OpalKelly::ProgressCallback::CCallback, callback
		);
	} else {
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGAFromMemoryWithReset(
	unsigned char* data, const unsigned long length, const okTFPGAResetProfile* reset
)
{
	return ((okCFrontPanel::ErrorCode
	)okFrontPanel_ConfigureFPGAFromMemoryWithReset(h, data, length, reset));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGAFromFlash(unsigned long configIndex)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_ConfigureFPGAFromFlash(h, configIndex));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetFPGAResetProfile(okEFPGAConfigurationMethod method, okTFPGAResetProfile* profile)
{
	return ((okCFrontPanel::ErrorCode
	)okFrontPanel_GetFPGAResetProfileWithSize(h, method, profile, sizeof(*profile)));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ReadRegister(UINT32 addr, UINT32* data)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_ReadRegister(h, addr, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ReadRegisters(std::vector<okTRegisterEntry>& regs)
{
	return ((okCFrontPanel::ErrorCode
	)okFrontPanel_ReadRegisters(h, (unsigned int)regs.size(), regs.empty() ? NULL : &regs[0]));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetFPGAResetProfile(
	okEFPGAConfigurationMethod method, const okTFPGAResetProfile* profile
)
{
	return ((okCFrontPanel::ErrorCode
	)okFrontPanel_SetFPGAResetProfileWithSize(h, method, profile, sizeof(*profile)));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::FlashEraseSector(UINT32 address)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_FlashEraseSector(h, address));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::FlashWrite(UINT32 address, UINT32 length, const UINT8* buf)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_FlashWrite(h, address, length, buf));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::FlashRead(UINT32 address, UINT32 length, UINT8* buf)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_FlashRead(h, address, length, buf));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::WriteRegister(UINT32 addr, UINT32 data)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_WriteRegister(h, addr, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::WriteRegisters(const std::vector<okTRegisterEntry>& regs)
{
	return ((okCFrontPanel::ErrorCode
	)okFrontPanel_WriteRegisters(h, (unsigned int)regs.size(), regs.empty() ? NULL : &regs[0]));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetWireInValue(int epAddr, UINT32* val)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_GetWireInValue(h, epAddr, val));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::WriteI2C(const int addr, int length, unsigned char* data)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_WriteI2C(h, addr, length, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ReadI2C(const int addr, int length, unsigned char* data)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_ReadI2C(h, addr, length, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetPLL22150Configuration(okCPLL22150& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_GetPLL22150Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetPLL22150Configuration(const okCPLL22150& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_SetPLL22150Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetEepromPLL22150Configuration(okCPLL22150& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_GetEepromPLL22150Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetEepromPLL22150Configuration(const okCPLL22150& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_SetEepromPLL22150Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetPLL22393Configuration(okCPLL22393& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_GetPLL22393Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetPLL22393Configuration(const okCPLL22393& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_SetPLL22393Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetEepromPLL22393Configuration(okCPLL22393& pll)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_GetEepromPLL22393Configuration(h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetEepromPLL22393Configuration(const okCPLL22393& pll)
{
...
inline bool
okCFrontPanel::IsFrontPanelEnabled()
{
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::UpdateWireIns()
{
	return (okCFrontPanel::ErrorCode)okFrontPanel_UpdateWireIns(h);
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetWireInValue(int ep, UINT32 val, UINT32 mask)
{
...
okCFrontPanel::GetWireOutValue(int epAddr)
{
	return (okFrontPanel_GetWireOutValue(h, epAddr));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ActivateTriggerIn(int epAddr, int bit)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_ActivateTriggerIn(h, epAddr, bit));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::UpdateTriggerOuts()
{
	return (okCFrontPanel::ErrorCode)okFrontPanel_UpdateTriggerOuts(h);
}
inline bool
okCFrontPanel::IsTriggered(int epAddr, UINT32 mask)
{
	return okFrontPanel_IsTriggered(h, epAddr, mask) == TRUE;
}
inline UINT32
okCFrontPanel::GetTriggerOutVector(int epAddr) const
{
	return okFrontPanel_GetTriggerOutVector(h, epAddr);
}
inline long
okCFrontPanel::GetLastTransferLength()
{
	return (okFrontPanel_GetLastTransferLength(h));
}
inline long
okCFrontPanel::WriteToPipeIn(int epAddr, long length, unsigned char* data)
{
	return (okFrontPanel_WriteToPipeIn(h, epAddr, length, data));
}
inline long
okCFrontPanel::ReadFromPipeOut(int epAddr, long length, unsigned char* data)
{
	return (okFrontPanel_ReadFromPipeOut(h, epAddr, length, data));
}
inline long
okCFrontPanel::WriteToBlockPipeIn(int epAddr, int blockSize, long length, unsigned char* data)
{
	return (okFrontPanel_WriteToBlockPipeIn(h, epAddr, blockSize, length, data));
}
inline long
okCFrontPanel::ReadFromBlockPipeOut(int epAddr, int blockSize, long length, unsigned char* data)
{
...
inline Buffer::Buffer(okBuffer_HANDLE hnd)
	: h(hnd)
{
}
inline Buffer::Buffer(size_t size)
	: h(okBuffer_Construct(SizeCast(size)))
{
}
inline Buffer::Buffer(void* ptr, size_t size)
	: h(okBuffer_FromData(ptr, SizeCast(size)))
{
}
inline Buffer::Buffer(const Buffer& buf)
	: h(okBuffer_Copy(buf.h))
{
}
inline Buffer&
Buffer::operator=(const Buffer& buf)
...
inline unsigned char
Buffer::operator[](size_t n) const
{
...
inline ScriptValue::ScriptValue(okScriptValue_HANDLE hnd)
	: h(hnd)
{
}
inline ScriptValue::ScriptValue(int n)
	: h(okScriptValue_NewInt(n))
{
}
inline ScriptValue::ScriptValue(bool b)
	: h(okScriptValue_NewBool(b))
{
}
inline ScriptValue::ScriptValue(const char* s)
	: h(okScriptValue_NewString(s))
{
}
inline ScriptValue::ScriptValue(const std::string& s)
	: h(okScriptValue_NewString(s.c_str()))
{
}
inline ScriptValue::ScriptValue(Buffer buf)
	: h(okScriptValue_NewBuffer(buf.h))
{
}
inline ScriptValue::ScriptValue(const ScriptValue& value)
	: h(okScriptValue_Copy(value.h))
{
}
inline ScriptValue&
ScriptValue::operator=(const ScriptValue& value)
...
inline bool
ScriptValue::GetAsInt(int* pn) const
{
	return okScriptValue_GetAsInt(h, pn);
}
inline bool
ScriptValue::GetAsBool(bool* pb) const
{
	return okScriptValue_GetAsBool(h, pb);
}
inline bool
ScriptValue::GetAsString(std::string* ps) const
{
	const char* pc;
...
inline bool
ScriptValue::GetAsBuffer(Buffer* pbuf) const
{
...
inline ScriptValues::ScriptValues()
	: h(okScriptValues_Construct())
{
}
inline ScriptValues::ScriptValues(okScriptValues_HANDLE hnd)
	: h(hnd)
{
}
inline void
...
inline void
ScriptValues::Add(const ScriptValue& value)
{
	okScriptValues_Add(h, value.h);
}
inline void
ScriptValues::Set(const ScriptValue& value)
{
	Clear();
	Add(value);
}
inline int
ScriptValues::GetCount() const
{
	return okScriptValues_GetCount(h);
}
inline ScriptValue
ScriptValues::Get(int n) const
{
...
inline ScriptValues::ScriptValues(const ScriptValues& values)
	: h(okScriptValues_Copy(values.h))
{
}
inline ScriptValues&
ScriptValues::operator=(const ScriptValues& values)
{
...
inline void
ScriptEngine::ConstructLua(OpalKellyLegacy::okCFrontPanel& fp)
{
	if (h)
...
inline bool
ScriptEngine::IsValid() const
{
	return h != NULL;
}
inline void
ScriptEngine::LoadScript(const std::string& name, const std::string& code)
{
	okError* error;
...
inline void
ScriptEngine::LoadFile(const std::string& path)
{
	okError* error;
...
inline void
ScriptEngine::PrependToScriptPath(const std::string& dir)
{
	okScriptEngine_PrependToScriptPath(GetHandle(), dir.c_str());
}
inline ScriptValues
ScriptEngine::RunScriptFunction(const std::string& name, const ScriptValues& args)
{
...
inline void
ScriptEngine::RunScriptFunctionAsync(
	AsyncResultHandler& handler, const std::string& name, const ScriptValues& args
)
{
	okError* error;
	if (!okScriptEngine_RunScriptFunctionAsync(
			GetHandle(), AsyncResultCallback, &handler, name.c_str(), args.h, &error
		))
		throw Impl::Error(error);
}
inline ScriptEngine::~ScriptEngine()
...
inline void
FrontPanelManager::StartMonitoring(CallbackInfo* cbInfo)
{
...
inline void
FrontPanelManager::StopMonitoring()
{
...
inline int
FrontPanelManager::EnterMonitorLoop(const CallbackInfo* cbInfo, int millisecondsTimeout)
{
	return okFrontPanelManager_EnterMonitorLoopWithTimeout(h, cbInfo, millisecondsTimeout);
}

inline void
FrontPanelManager::ExitMonitorLoop(int exitCode)
{
	okFrontPanelManager_ExitMonitorLoop(h, exitCode);
}

inline OpalKellyLegacy::okCFrontPanel*
FrontPanelManager::Open(const char* serial)
{
...
FrontPanelEmulateTestDeviceConnection(const std::string& serial, bool connect)
{
	return ((FrontPanel::ErrorCode
	)okFrontPanelManager_EmulateTestDeviceConnection(serial.c_str(), connect));
}
...
inline int
FrontPanelDevices::GetCount() const
{
	return okFrontPanelDevices_GetCount(h);
}
inline std::string
FrontPanelDevices::GetSerial(int num) const
{
	char str[MAX_SERIALNUMBER_LENGTH + 1];
...
inline FrontPanelPtr
FrontPanelDevices::Open(const std::string& serial) const
{
